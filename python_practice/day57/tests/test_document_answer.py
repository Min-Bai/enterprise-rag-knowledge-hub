...
from python_practice.day57.schemas.ai import DocumentAnswerRequest
from python_practice.day57.services.ai import (
    AiProviderError,
...
def test_success_returns_answer_and_sources(monkeypatch):
    ...
    monkeypatch.setattr(
        "python_practice.day57.services.ai.DEEPSEEK_API_KEY",
        "test-key",
    )
